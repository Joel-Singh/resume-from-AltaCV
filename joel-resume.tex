...
\begin{document}
\name{Joel Singh}
\tagline{Denison Student, QuestBridge Scholar}
...
\cvevent{Waldo}{React, Typescript, and Jest}{}{}
\begin{itemize}
...
\cvevent{Florally Great}{CRUD, Express, MongoDB, Typescript, TDD with Jest}{}{}
\begin{itemize}
...
\cvevent{Robot-2024}{Robot Code, WPILIB Java}{}{}
\begin{itemize}
...
\divider
\cvevent{Match 3 Game}{Bevy Rust}{}{}
\begin{itemize}
\item Simple Match 3 Game made with Rust using the Bevy Game Engine
\item \href{https://github.com/Joel-Singh/match-3-game}{\underline{Source}} \href{https://joel-singh.github.io/match-3-game}{\underline{Live Demo}}
\end{itemize}
...
\cvachievement{\faBook}{Top 25 class rank out of 600 in HS}{Based on GPA}
...
\cvachievement{\faBook}{2022 and 2023 AP Scholar with Distinction}{Collegeboard}
...
\cvevent{B.S. Computer Science}{Denison University}{2024 - Current}{}

\divider

\cvevent{HS Degree}{East Ridge HS}{2020 - 2024}{}
